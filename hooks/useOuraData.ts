...
export const fetchDailyStats = async (
    ...
    const canFetchStress = !scopesKnown || hasDailyScope || hasAnyOuraScope(normalizedScopes, [...OURA_SCOPE_CANDIDATES.stress]);
    const canFetchResilience = !scopesKnown || hasDailyScope || hasAnyOuraScope(normalizedScopes, [...OURA_SCOPE_CANDIDATES.resilience]);
